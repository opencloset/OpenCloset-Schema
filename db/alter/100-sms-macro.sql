...
INSERT INTO `sms_macro` (`name`, `from`, `text`) VALUES
  ('계좌 이체', '07043257521', '[열린옷장] 안녕하세요. 열린옷장에 결제할 추가금액은 ***원 입니다. 당일 내로 입금 부탁드립니다. / 국민은행 205737-04-003013 (예금주: 사단법인 열린옷장)'),
  ('전화 요망', '07043257521', '안녕하세요. 열린옷장입니다. 전화부탁드립니다.'),
...
감사합니다 :)'),
  ('온라인 입금 안내', '07043257521', '[열린옷장] 대여 금액 00000원, 1시까지 입금해주세요. 국민은행 205737-04-003013'),
  ('온라인 자동 취소 고지', '07043257521', '[열린옷장] 00님 금일 3시까지 입금되지 않을 경우 발송 취소 됨을 알립니다.'),
  ('SMS 인증발송', '07043257521', '열린옷장입니다. 전화번호 확인을 위해 SMS 확인 문자를 발송하였습니다. 인증번호는 OOOO입니다. 발송된 인증번호를 담당자에게 보여주시기 바랍니다'),
  ('최종통보', '07043257521', '[열린옷장] ooo님 대여기간이 oo일 연체되었습니다. 더 이상 반납의사가 없다고 판단되어 명일(0/0) 내용증명서가 발송됩니다. 추후 광진경찰서에 고소장 접수 후 법적 절차를 통해 정장을 회수할 예정입니다. 참고 바라며, 최종 고지하는 것이오니 바로 답변바랍니다.'),
  ('방문대여 예약 가이드', '07043257521', '[열린옷장] 방문대여 예약 가이드, 링크 참고하셔서 예약하세요.^^ http://goo.gl/3Q1BB9'),
...
이용에 참고하시기 바랍니다. 감사합니다.'),
  ('장기 미납자 안내', '07043257521', '[열린옷장] ooo님, 대여연장 혹은 반납연체로 발생된 미납 금액 00,000원이 아직 입금되지 않아서 다시 연락드렸습니다. 금주 내로 지정계좌에 입금 부탁드리겠습니다.  국민은행 205737-04-003013'),
